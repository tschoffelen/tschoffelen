  ...
  <Layout>
    ...
    <ol>
      <li>
        ...
        <ol type="a">
          <li>
            Our site address is <a href="https://schof.co">https://schof.co</a>
          </li>
      ...
      <li>
        ...
        <ol type="a">
          <li>
            ...
            time, including your name, email address, postal address, telephone
            number, and location information.
          </li>
          <li>
            If you choose to access the Website using a social networking
            profile, we may collect and store details of that social networking
            profile.
          </li>
      ...
      <li>
        ...
        <ol type="a">
          ...
          <li>
            ...
            purchase you are consenting to receive taretted promotional material
            from us. We offer you the option to opt out of some or all of these
            communications via a link in the footer of all our promotional
            emails or by sending an email to{" "}
            <a href="mailto:info@schof.co">info@schof.co</a>.
          </li>
          <li>
            Deal with any enquires or complaints submitted by you, our Shops or
            Partner.
          </li>
    ...
    <ol>
      <li>
        ...
        Economic Area (EEA). It may be processed outside the EEA to fulfil your
        order and deal with payment.
      </li>
      <li>
      ...
      <li>
        ...
        protection, we cannot guarantee complete security for your data, and you
        take the risk that any sending of that data turns out to be not secure
        despite our efforts.
      </li>
    </ol>
    ...
    <ol>
      <li>
        ...
        <ol type="a">
          <li>
            If we want to sell our business, or our company, we can disclose it
    ...
    <ol>
      <li>
        ...
        at <a href="mailto:info@schof.co">info@schof.co</a>.
      </li>
      <li>

...
export const TextInput = ({ title, value, onChange, ...props }) => {
  const id = title.toLowerCase().replace(/[^\w]+/ig, "");
  return (
    <>
...
export const Checkboxes = ({ title, options, value = [], onChange, ...props }) => {
  return (
    <>
          ...
          <div className="trigger">
            ...
            <select
              ...
              <optgroup label="EventBridge">
                ...
                <option value='eventBridgeSource'>EventBridge default bus</option>
            ...
            <TriggerProperties event={event} onChange={(key, val) => updateTrigger(id, key, val)}/>
            <span>
              <Trash
        ...
        <>
          ...
          <span>
            <HelpCircle
              size={18}
              color='#355fc5'
              onClick={() => window.open("https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-develop-routes.html")}/>
          </span>
        </>
      );
    case "scheduleRate":
        ...
        <>
          ...
          <span>
            <HelpCircle
              size={18}
              color='#355fc5'
              onClick={() => window.open("https://docs.aws.amazon.com/eventbridge/latest/userguide/scheduled-events.html#rate-expressions")}/>
          </span>
        </>
      );
    case "scheduleCron":
        ...
        <>
          ...
          <span>
            <HelpCircle
              size={18}
              color='#355fc5'
              onClick={() => window.open("https://docs.aws.amazon.com/eventbridge/latest/userguide/scheduled-events.html#cron-expressions")}/>
          </span>
        </>
      );
        ...
        <>
          ...
          <span>
            <HelpCircle
              size={18}
              color='#355fc5'
              onClick={() => window.open("https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html#notification-how-to-event-types-and-destinations")}/>
          </span>
        </>
      );
    default:

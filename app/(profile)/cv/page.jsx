export default function CV() {
  return (
    <div className="p-6 my-8 md:my-20 max-w-3xl mx-auto text-gray-900">
      <h1 className="font-semibold text-3xl md:text-5xl">Thomas Schoffelen</h1>
      <h3 className="mt-3 mb-10 md:text-xl">
        Software Tech Lead &amp; Entrepreneur
      </h3>
      <div className="divide-y border-t border-gray-200 divide-gray-200 flex flex-col gap-8">
        ...
        <div className="md:grid grid-cols-4 gap-8 pt-8">
          ...
          <div className="col-span-3">
            <dl className="grid grid-cols-3 text-gray-700">
              <dt>Full name</dt>
              <dd className="col-span-2 text-gray-800 mb-2">
              ...
              <dt>Birth date</dt>
              <dd className="col-span-2 text-gray-800 mb-2">March 11, 1997</dd>
              <dt>Email</dt>
              <dd className="col-span-2 text-gray-800 mb-2">
                <a
                  href="mailto:thomas@schof.co"
                  className="border-b transition hover:border-gray-800"
                >
                  thomas@schof.co
                </a>
              </dd>
        ...
        <div className="md:grid grid-cols-4 gap-8 pt-8">
          ...
          <div className="col-span-3 prose">
            ...
            <h4>
              ...
              <br />
              <span className="font-normal">Co-Founder, CTO (2017 — 2019)</span>
            </h4>
            <p>

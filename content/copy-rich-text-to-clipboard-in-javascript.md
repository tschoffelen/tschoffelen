---
title: Copy Rich Text to Clipboard in JavaScript
date: 2025-11-21
description: I really like how in Linear, if you press  Cmd + C , which is listed as 'Copy issue title', it will copy the title as plain text, but also as an HTML...
taxonomies:
  category:
    - Reference
extra: {}
